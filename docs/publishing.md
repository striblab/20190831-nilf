...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20190131-nilf">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20190131-nilf/",
      "url": "http://static.startribune.com/news/projects-staging/all/20190131-nilf/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20190131-nilf/",
      "url": "http://static.startribune.com/news/projects/all/20190131-nilf/"
    }
  }
}
```
